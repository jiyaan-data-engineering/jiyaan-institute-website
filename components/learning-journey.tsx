...
export function LearningJourney() {
  return (
    <section id="curriculum-learn" className="section-pad scroll-mt-24" aria-labelledby="journey-title">
      <div className="container-x">
        ...
        <Reveal delay={600}>
          <div className="mt-12 text-center">
            ...
            <a
              href="#enroll"
              className="mt-4 inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-cyan to-google-blue px-8 py-3 font-display font-bold text-background transition-all hover:shadow-lg hover:shadow-cyan/25 active:scale-95"
            >
              Enroll Now
              <span>→</span>
            </a>
