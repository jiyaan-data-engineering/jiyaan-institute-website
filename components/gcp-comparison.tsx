...
const benefits = [
  ...
  { icon: Database, title: "Data Native", desc: "Built for data engineering from the ground up." },
]

export function GcpComparison() {
  return (
    <section id="why-gcp" className="section-pad bg-surface/30" aria-labelledby="why-gcp-title">
