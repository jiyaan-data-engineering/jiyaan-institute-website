...
export function TrackRecord() {
  return (
    <section className="section-pad" aria-labelledby="track-title">
      <div className="container-x">
        ...
        {/* Urgency CTA */}
        <Reveal delay={900}>
          <div className="mt-12 rounded-lg border-2 border-google-red/30 bg-gradient-to-r from-google-red/5 to-orange-500/5 p-8 text-center">
            ...
            <a
              href="#lead-form"
              className="mt-6 inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-google-red to-orange-500 px-8 py-3 font-display font-bold text-white transition-all hover:shadow-lg hover:shadow-google-red/25 active:scale-95"
            >
