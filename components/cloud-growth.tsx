...
const providers: Provider[] = [
  ...
  },
  {
    key: "aws",
    name: "Amazon AWS",
    badge: "bg-google-yellow/10 text-google-yellow border-google-yellow/20",
    color: "linear-gradient(180deg,#fbbc04,#f9a825)",
    bars: [
  ...
  },
  {
    ...
    color: "linear-gradient(180deg,#4285f4,#1a73e8)",
    bars: [
...
const insights = [
  ...
  { title: "AWS Position", desc: "Largest market share but slower relative growth.", border: "border-google-yellow", bg: "bg-google-yellow/10" },
